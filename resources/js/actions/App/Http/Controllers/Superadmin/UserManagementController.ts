 ...
 * @see app/Http/Controllers/Superadmin/UserManagementController.php:18
 ...
 * @see app/Http/Controllers/Superadmin/UserManagementController.php:36
 * @route '/superadmin/users'
 */
 ...
 * @see app/Http/Controllers/Superadmin/UserManagementController.php:0
 * @route '/superadmin/users/{user}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/superadmin/users/{user}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/Superadmin/UserManagementController.php:73
 * @route '/superadmin/users/{user}'
 */
 ...
 * @see app/Http/Controllers/Superadmin/UserManagementController.php:115
 * @route '/superadmin/users/{user}'
 */
